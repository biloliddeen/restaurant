    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            echo \yii\bootstrap4\Carousel::widget([
                'items' => [
                    [
                        'content' => \yii\helpers\Html::img(\Yii::getAlias('@carouselImgUrl').'/'.$carousel[0]['image']),
                    ...
                    [
                        'content' => \yii\helpers\Html::img(\Yii::getAlias('@carouselImgUrl').'/'.$carousel[1]['image']),
                    ...
                    [
                        'content' => \yii\helpers\Html::img(\Yii::getAlias('@carouselImgUrl').'/'.$carousel[2]['image']),
